	...
	$.ajax({
		...
		success:function (data){
			...
			if(data.code==200)
			{
				...
				$('#WrongMessage').fadeIn(2000,function(){$('#WrongMessage').fadeOut(1500,function(){window.location.href="index.html"})});
			...
			else if(data.code==410)
			{
				...
				$('#WrongMessage').html(data.msg);
				$('#WrongMessage').fadeIn(3000,function(){$('#WrongMessage').fadeOut(1500,function(){window.location.href="orderPage.html"})});
		...
		error:function (){
				...
				$('#WrongMessage').fadeIn(2000,function(){$('#WrongMessage').fadeOut(1500,function(){window.location.href="orderPage.html"})})
